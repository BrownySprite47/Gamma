...
function status($checked, $id_lid_recom, $user_id, $exist, $direction){

    if($exist == undefined){ $exist = '0'; }
    if($direction == undefined){ $direction = ''; }

    $.post(
        '/ajax/index/status/change/recommends',
        {
...
// function users() {
//     $.post(
//         '/ajax/admin/doubles/get_recommends',
//         {
...
// function leaders() {
//     $.post(
//         '/ajax/admin/doubles/get_doubles',
//         {
