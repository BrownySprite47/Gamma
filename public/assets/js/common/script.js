...
function upload($id_type, $id_change, $progressbar, $id_preview = 'preview', $counter = ''){
    if($id_type == 'img') {
        $url = '/ajax/general/upload_img/index';
    }
    if($id_type == 'file') {
        $url = '/ajax/general/upload_file/index';
    }
