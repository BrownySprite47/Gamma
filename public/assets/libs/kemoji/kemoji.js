(function(){
    ...
    function Emoji(KEmojiElement, id, options)
    {
        ...
        inputElementContainer.innerHTML = '<div id="editable" contenteditable="true" tabindex="1"> </div>';
        ...
        function insertSmileAtCursor(smile) {
            ...
            k.attr(img, 'src', '/assets/libs/kemoji/img/opacity.png');
            k.addClass(img, 'ke');
        ...
        this.setValue = function(value, dataType){
            if(!dataType || dataType == KEmoji.TEXT_VALUE)
                inputElement.innerHTML = value.replace(/\$#(.*?)#\$/g, '<img src="/assets/libs/kemoji/img/opacity.png" onresizestart="return false" class="ke ke-$1">');
            else if(dataType == KEmoji.HTML_VALUE)
