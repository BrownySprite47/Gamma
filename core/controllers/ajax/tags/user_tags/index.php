...
function index(){
    if (isset($_POST['tags'])) {
        ...
        foreach ($tags_id[0] as $key => $value) dbQuery ("INSERT INTO tags_leaders SET id_tag = '".$value."', id_lid = '".$_SESSION['id_lid']."', type = '1'");
        foreach ($tags_id[1] as $key => $value) dbQuery ("INSERT INTO tags_leaders SET id_tag = '".$value."', id_lid = '".$_SESSION['id_lid']."', type = '0'");
