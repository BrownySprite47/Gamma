<div class="container-fluid">
    <div class="list-group-item title_menu_admin"><h2>СОЗДАТЬ НОВОСТЬ</h2>
        ...
        <div class="col-xs-9 info_box">
            <div class="wrapper profile">
                ...
                <div class="col-xs-12">
                    ...
                    <input type="text" name="prev_content" class="form-control" id="prev_content">
                </div>
                <div class="col-xs-12">
                    <label for="otchestvo">Описание новости*</label>
                    <textarea required style="resize: none;" class="form-control" rows="15" id="content" name="content"></textarea>
                </div>
            </div>
            <div class="wrap_buttons">
                ...
                <div class="col-xs-6 wrap_btn">
                    <span id="result_public"><img src='/assets/images/checkmark.svg'>Новость успешно опубликована!</span>
                </div>
            </div>
        </div>
