<div class="container-fluid" id="content-main-height">
                                ...
                                <?php foreach ($data as $value): ?>
                                    <tr>
                                        ...
                                        <?php if (!empty($value['fio'])): ?>
                                            <td scope="col"><a href="/index/leaders/view?id="<?= $value['user'] ?>><?= $value['fio'] ?></a></td>
                                        <?php else: ?>
                                            <td scope="col">Нет ФИО</a></td>
                                        <?php endif; ?>
                                        <?php if (!empty($value['project_title'])): ?>
                                            <td scope="col"><a href="/index/projects/view?id="<?= $value['id_proj'] ?>><?= $value['project_title'] ?></a></td>
                                        <?php else: ?>
