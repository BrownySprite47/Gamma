    ...
    <form method="post" enctype="multipart/form-data" >
        ...
        <div class="col-lg-7 info_box">
            <div class="wrapper profile">
                ...
                <div class="col-lg-6 block_indent">
                    <label>Сайт*</label>
                    <input required placeholder="Сайт или группа в соц. сетях" type="text" class="form-control valid_url" name="site">
                </div>
                <div class="col-xs-12 block_indent">
            ...
            <div class="wrap_buttons">
                ...
                <?php else : ?>
                    <div class="col-lg-4 wrap_btn"><a class="back_btn" href="/user">Вернуться назад</a></div>
                <?php endif; ?>
            </div>
        </div>
    </form>
