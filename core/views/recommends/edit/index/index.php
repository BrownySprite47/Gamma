            ...
            <div class="col-xs-7 info_box">
                <div class="wrapper profile">
                    ...
                    <div class="col-xs-4">
                        ...
                        <input type="text" required name="familya" class="form-control" id="familya" value="<?= $data["leaders"][0]["familya"] ?>">
                    </div>
                    <div class="col-xs-4">
                        <label for="name">Имя*</label>
                        <input type="text" required name="name" class="form-control" id="name" value="<?= $data["leaders"][0]["name"] ?>">
                    </div>
                    <div class="col-xs-4">
                        <label for="otchestvo">Отчество</label>
                        <input type="text" name="otchestvo" class="form-control" id="otchestvo" value="<?= $data["leaders"][0]["otchestvo"] ?>">
                    </div>
                    <div class="col-xs-4">
                        <label for="project">Проект*</label>
                        <input type="text" required name="project" class="form-control" id="project" value="<?= $data["leaders"][0]["project"] ?>">
                    </div>
                    <div class="col-xs-12">
                        <label for="city">Город*</label>
                        <input required placeholder="Например: Москва" type="text" name="city" class="form-control" id="city" value="<?= $data["leaders"][0]["city"] ?>">
                    </div>
                    <div class="col-xs-12">
                        <label for="birthday">Дата рождения*</label>
                        <div class="input-group date form_date" data-date-format="dd.mm.yyyy" data-link-format="yyyy.mm.dd">
                            <input required placeholder="дд.мм.гггг" id="birthday" name="birthday" class="form-control" type="text" value="<?= $data["leaders"][0]["birthday"] ?>" readonly>
                    ...
                    <div class="col-xs-12">
                        ...
                        <input required placeholder="http://" type="text" name="social" class="form-control valid_required valid_url" id="social" value="<?= $data["leaders"][0]["social"] ?>">
                    </div>
                    <div class="col-xs-12">
                        <label for="telephone">Телефон</label>
                        <input placeholder="+7 xxx xxx xxxx" type="text" name="telephone" class="form-control" id="telephone" value="<?= $data["leaders"][0]["telephone"] ?>">
                        <span class="not_public">— не отображается в публичном профиле</span>
                    </div>
                    <div class="col-xs-12">
                        <label for="email">E-mail</label>
                        <input placeholder="E-mail" type="text" name="email" class="form-control" id="email" value="<?= $data["leaders"][0]["email"] ?>">
                        <span class="not_public">— не отображается в публичном профиле</span>
                    </div>
                    <div class="col-xs-12">
                        <label for="contact_info">Дополнительная контактная информация</label>
                        <input placeholder="Дополнительная контактная информация" type="text" name="contact_info" class="form-control" id="contact_info" value="<?= $data["leaders"][0]["contact_info"] ?>">
                    </div>
                    <div class="col-xs-12">
                ...
                <div class="wrap_buttons">
                    ...
                    <div class="col-xs-4 wrap_btn"><a class="back_btn" href="/user/recommends">Вернуться в рекомендации</a></div>
                </div>
            </div>
