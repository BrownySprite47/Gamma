    ...
    <head>
        ...
        <link rel="stylesheet" href="/assets/css/common/media.css">
                ...
                <div id="header_sidebar" class="header_sidebar visible-xs">
                    <ul class="nav">
                        ...
                        <li class="logo_cl <?= isset($data['user_logo']) ? 'active_menu_sidebar' : '' ?> user_logo">
                            <a href="/user"><img src="/assets/images/user.svg"><br><span>Профиль</span></a>
                        </li>
                        <li class="logo_cl <?= isset($data['recomendations']) ? 'active_menu_sidebar' : '' ?> logo_recomendations">
                            <a href="/user/recommends"><img src="/assets/images/recomendations.svg"><br><span>Рекомендации</span></a>
                        </li>
                        <li class="logo_cl <?= isset($data['change_experience']) ? 'active_menu_sidebar' : '' ?> logo_change_experience">
                            <a href="/user/tags"><img src="/assets/images/change_experience.svg"><br><span>Обмен опытом</span></a>
                        </li>
<!--                        <li><a href="/logout"><span>Выход</span><img src="/assets/images/exit.svg"></a></li>-->
                        <li class="logo_img_li exit_mobile"><a href="/logout" class="dropdown-toggle"><span>Выход</span><img src="/assets/images/exit.svg"></a></li>
                        <?php else: ?>
