...
<div id="content-main">
    <div class="container-fluid">
        ...
        <div class="wrap_admin_links">
            <div class="col-xs-12"><p>Название: <?= $data['file'][0]['title'] ?></p></div>
            <div class="col-xs-12">
                <p>Файл:
                    <a class="user_files" target="_blank" href="/uploads/files/<?= $data['file'][0]['filename'] ?>">
                        <?= $data['file'][0]['filename'] ?>
                    </a>
                </p>
            </div>
            <div class="col-xs-12"><p><a target="_blank" href="<?= CORE_FILE_PATH . $data['file'][0]['filename'] ?>">Открыть</a></p></div>
        </div>
        <div class="inner_comments_box">
            ...
            <div id="comment_box" class="wrapper_comments col-lg-7">
                <?php if (isset($data['comments'][0])): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <span class="no_comments">К данному файлу еще нет комментариев.</span>
                <?php endif; ?>
            </div>
